...
import { CommonAction, CommonDialogAction, GetStateAction, ThunkResult } from '~types/action';
...
export const showDialog = (payload: CommonDialogAction): ThunkResult<Promise<CommonAction>, CommonAction> =>
...
export const hideDialog = (index: number): CommonDialogAction => ({
